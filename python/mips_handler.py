...
COMMAND_LOAD_PROGRAM     = 0x4C # L in ASCII
COMMAND_EXECUTE          = 0x45 # E in ASCII
COMMAND_EXECUTE_BY_STEPS = 0x53 # S in ASCII
COMMAND_EXECUTE_DEBUG    = 0x44 # D in ASCII
COMMAND_DELETE           = 0x46 # F in ASCII
COMMAND_NEXT_STEP        = 0x4E # N in ASCII
COMMAND_STOP_EXECUTION   = 0x53 # S in ASCII
