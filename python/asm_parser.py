...
class asmParser():
    ...
    def buildSymbolTable(self, lines):
        self.outputArray = []       # Store the output machine code in a human-readable format.
        self.instructions = []      # Store the machine code instructions.
        self.symbolTable = {}       # Store labels and their corresponding memory addresses.
        self.currentLocation = 0    # Keeps track of the current memory address during parsing.
